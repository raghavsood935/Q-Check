...
class ModelTestAnethum extends StatefulWidget {
  @override
  _ModelTestAnethumState createState() => _ModelTestAnethumState();
}

class _ModelTestAnethumState extends State<ModelTestAnethum> {
  bool _loading = false;
  File? _image;
  List? _output;
  ...
  void loadModel() async {
    await Tflite.loadModel(
      model: "assets/models/model_anethum.tflite",
      labels: "assets/labels/labelsanethum.txt",
    );
  }

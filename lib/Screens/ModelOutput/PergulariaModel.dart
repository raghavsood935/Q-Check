...
class ModelTestPergularia extends StatefulWidget {
  @override
  _ModelTestPergulariaState createState() => _ModelTestPergulariaState();
}

class _ModelTestPergulariaState extends State<ModelTestPergularia> {
  bool _loading = false;
  File? _image;
  List? _output;
    ...
    _output != null && (_output![0]['label'].toString().substring(0, 1) == "1")
        ? Future.delayed(Duration(milliseconds: 1000), () {
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => const PergulariaDaemia()));
          })
        : Future.delayed(Duration(milliseconds: 1000), () {
            _onAlertButtonPressed1(context);
          });
  ...
  void loadModel() async {
    await Tflite.loadModel(
      model: "assets/models/model_pergularia.tflite",
      labels: "assets/labels/labelspergularia.txt",
    );
  }

...
class ModelTestSchinusMole extends StatefulWidget {
  @override
  _ModelTestSchinusMoleState createState() => _ModelTestSchinusMoleState();
}

class _ModelTestSchinusMoleState extends State<ModelTestSchinusMole> {
  bool _loading = false;
  File? _image;
  List? _output;
    ...
    _output != null && (_output![0]['label'].toString().substring(0, 1) == "0")
        ? Future.delayed(Duration(milliseconds: 1000), () {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => SchinusMole()));
          })
        : Future.delayed(Duration(milliseconds: 1000), () {
            _onAlertButtonPressed1(context);
          });
  ...
  void loadModel() async {
    await Tflite.loadModel(
      model: "assets/models/model_schinusmole.tflite",
      labels: "assets/labels/labelsschinusmole.txt",
    );
  }

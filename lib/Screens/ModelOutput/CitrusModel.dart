...
class ModelTestCitrusSinesis extends StatefulWidget {
  @override
  _ModelTestCitrusSinesisState createState() => _ModelTestCitrusSinesisState();
}

class _ModelTestCitrusSinesisState extends State<ModelTestCitrusSinesis> {
  bool _loading = false;
  File? _image;
  List? _output;
    ...
    _output != null && (_output![0]['label'].toString().substring(0, 1) == "0")
        ? Future.delayed(Duration(milliseconds: 1000), () {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => CitrusSinensis()));
          })
        : Future.delayed(Duration(milliseconds: 1000), () {
            _onAlertButtonPressed1(context);
          });
  ...
  void loadModel() async {
    await Tflite.loadModel(
      model: "assets/models/model_citrus.tflite",
      labels: "assets/labels/labelscitrus.txt",
    );
  }

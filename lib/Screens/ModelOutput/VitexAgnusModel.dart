...
class ModelTestVitexAgnus extends StatefulWidget {
  @override
  _ModelTestVitexAgnusState createState() => _ModelTestVitexAgnusState();
}

class _ModelTestVitexAgnusState extends State<ModelTestVitexAgnus> {
  bool _loading = false;
  File? _image;
  List? _output;
    ...
    _output != null && (_output![0]['label'].toString().substring(0, 1) == "0")
        ? Future.delayed(Duration(milliseconds: 1000), () {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => VitexAgnusCastus()));
          })
        : Future.delayed(Duration(milliseconds: 1000), () {
            _onAlertButtonPressed1(context);
          });
  ...
  void loadModel() async {
    await Tflite.loadModel(
      model: "assets/models/model_vitexagnus.tflite",
      labels: "assets/labels/labelsvitexagnus.txt",
    );
  }

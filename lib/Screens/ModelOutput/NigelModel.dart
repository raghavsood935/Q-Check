...
class ModelTestNigelSativa extends StatefulWidget {
  @override
  _ModelTestNigelSativaState createState() => _ModelTestNigelSativaState();
}

class _ModelTestNigelSativaState extends State<ModelTestNigelSativa> {
  bool _loading = false;
  File? _image;
  List? _output;
  ...
  void loadModel() async {
    await Tflite.loadModel(
      model: "assets/models/model_nigelsativa.tflite",
      labels: "assets/labels/labelsnigelsativa.txt",
    );
  }

...
class ModelTestAmomumSublatum extends StatefulWidget {
  @override
  _ModelTestAmomumSublatumState createState() =>
      _ModelTestAmomumSublatumState();
}

class _ModelTestAmomumSublatumState extends State<ModelTestAmomumSublatum> {
  bool _loading = false;
  File? _image;
  List? _output;
    ...
    _output != null && (_output![0]['label'].toString().substring(0, 1) == "0")
        ? Future.delayed(Duration(milliseconds: 1000), () {
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => const AmomumSublatum()));
          })
        : Future.delayed(Duration(milliseconds: 1000), () {
            _onAlertButtonPressed1(context);
          });
  ...
  void loadModel() async {
    await Tflite.loadModel(
      model: "assets/models/model_amomum.tflite",
      labels: "assets/labels/labelsamomum.txt",
    );
  }

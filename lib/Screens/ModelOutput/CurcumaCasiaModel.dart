...
class ModelTestCurcumaCasia extends StatefulWidget {
  @override
  _ModelTestCurcumaCasiaState createState() => _ModelTestCurcumaCasiaState();
}

class _ModelTestCurcumaCasiaState extends State<ModelTestCurcumaCasia> {
  bool _loading = false;
  File? _image;
  List? _output;
    ...
    _output != null && (_output![0]['label'].toString().substring(0, 1) == "0")
        ? Future.delayed(Duration(milliseconds: 1000), () {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => const CurcumaCasia()));
          })
        : Future.delayed(Duration(milliseconds: 1000), () {
            _onAlertButtonPressed1(context);
          });
  ...
  void loadModel() async {
    await Tflite.loadModel(
      model: "assets/models/model_curcumacasia.tflite",
      labels: "assets/labels/labelscurcumacasia.txt",
    );
  }

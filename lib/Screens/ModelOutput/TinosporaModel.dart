...
import 'package:q_check/Screens/herbs/herbs_details/falsegiloy.dart';
import 'package:q_check/Screens/herbs/herbs_details/giloy.dart';
import 'package:tflite/tflite.dart';
import 'dart:io';

class ModelTestTinospora extends StatefulWidget {
  @override
  _ModelTestTinosporaState createState() => _ModelTestTinosporaState();
}

class _ModelTestTinosporaState extends State<ModelTestTinospora> {
  bool _loading = false;
  File? _image;
  List? _output;
    ...
    if (_output != null &&
      ...
      Future.delayed(Duration(milliseconds: 1000), () {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => const TinoSporaCordifolia()));
      });
    } else if (_output != null &&
        (_output![0]['label'].toString().substring(0, 1) == "1")) {
      Future.delayed(Duration(milliseconds: 1000), () {
        Navigator.push(context,
            MaterialPageRoute(builder: (context) => const PergulariaDaemia()));
      });
    } else {
      Future.delayed(Duration(milliseconds: 1000), () {
        _onAlertButtonPressed1(context);
  ...
  void loadModel() async {
    await Tflite.loadModel(
      model: "assets/models/model_tinospora.tflite",
      labels: "assets/labels/labelstinospora.txt",
    );
  }

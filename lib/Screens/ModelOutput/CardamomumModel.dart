...
import 'package:q_check/Screens/spices/spices_details/badielaichi.dart';
import 'package:q_check/Screens/spices/spices_details/eliachi.dart';
import 'package:q_check/Screens/spices/spices_details/santara.dart';
import 'package:tflite/tflite.dart';
import 'dart:io';

class ModelTestCardamomum extends StatefulWidget {
  @override
  _ModelTestCardamomumState createState() => _ModelTestCardamomumState();
}

class _ModelTestCardamomumState extends State<ModelTestCardamomum> {
  bool _loading = false;
  File? _image;
  List? _output;
    ...
    if (_output != null &&
      ...
      Future.delayed(Duration(milliseconds: 1000), () {
        Navigator.push(context,
            MaterialPageRoute(builder: (context) => ElettariaCardamomum()));
      });
    } else if (_output != null &&
        (_output![0]['label'].toString().substring(0, 1) == "1")) {
      Future.delayed(Duration(milliseconds: 1000), () {
        Navigator.push(context,
            MaterialPageRoute(builder: (context) => const AmomumSublatum()));
      });
    } else if (_output != null &&
        (_output![0]['label'].toString().substring(0, 1) == "2")) {
      Future.delayed(Duration(milliseconds: 1000), () {
        Navigator.push(context,
            MaterialPageRoute(builder: (context) => const CitrusSinensis()));
      });
    } else {
      Future.delayed(Duration(milliseconds: 1000), () {
        _onAlertButtonPressed1(context);
  ...
  void loadModel() async {
    await Tflite.loadModel(
      model: "assets/models/model_cardamomum.tflite",
      labels: "assets/labels/labelscardamomum.txt",
    );
  }

...
class ModelTestFoeniculum extends StatefulWidget {
  @override
  _ModelTestFoeniculumState createState() => _ModelTestFoeniculumState();
}

class _ModelTestFoeniculumState extends State<ModelTestFoeniculum> {
  bool _loading = false;
  File? _image;
  List? _output;
  ...
  classifyImage(File image) async {
    ...
    if (_output != null &&
      ...
      Future.delayed(Duration(milliseconds: 1000), () {
        Navigator.push(context,
            MaterialPageRoute(builder: (context) => const AnethumGraveolens()));
      });
    } else if (_output != null &&
        (_output![0]['label'].toString().substring(0, 1) == "2")) {
      Future.delayed(Duration(milliseconds: 1000), () {
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => CarumCarvi()));
      });
    } else if (_output != null &&
  ...
  void loadModel() async {
    await Tflite.loadModel(
      model: "assets/models/model_fenalnew.tflite",
      labels: "assets/labels/labelsfenalnew.txt",
    );
  }

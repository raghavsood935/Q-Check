...
class ModelTestPolyalthia extends StatefulWidget {
  @override
  _ModelTestPolyalthiaState createState() => _ModelTestPolyalthiaState();
}

class _ModelTestPolyalthiaState extends State<ModelTestPolyalthia> {
  bool _loading = false;
  File? _image;
  List? _output;
  ...
  classifyImage(File image) async {
    ...
    _output != null && (_output![0]['label'].toString().substring(0, 1) == "1")
  ...
  void loadModel() async {
    await Tflite.loadModel(
      model: "assets/models/model_polyalthia.tflite",
      labels: "assets/labels/labelspolyalthia.txt",
    );
  }

...
class ModelTestCurcumaZeodaria extends StatefulWidget {
  @override
  _ModelTestCurcumaZeodariaState createState() =>
      _ModelTestCurcumaZeodariaState();
}

class _ModelTestCurcumaZeodariaState extends State<ModelTestCurcumaZeodaria> {
  bool _loading = false;
  File? _image;
  List? _output;
    ...
    _output != null && (_output![0]['label'].toString().substring(0, 1) == "0")
        ? Future.delayed(Duration(milliseconds: 1000), () {
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => const CurcumaZeoderia()));
          })
        : Future.delayed(Duration(milliseconds: 1000), () {
            _onAlertButtonPressed1(context);
          });
  ...
  void loadModel() async {
    await Tflite.loadModel(
      model: "assets/models/model_curcumazeodaria.tflite",
      labels: "assets/labels/labelscurcumazeodaria.txt",
    );
  }

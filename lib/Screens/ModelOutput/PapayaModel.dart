...
class ModelTestPapaya extends StatefulWidget {
  @override
  _ModelTestPapayaState createState() => _ModelTestPapayaState();
}

class _ModelTestPapayaState extends State<ModelTestPapaya> {
  bool _loading = false;
  File? _image;
  List? _output;
  ...
  void loadModel() async {
    await Tflite.loadModel(
      model: "assets/models/model_papaya.tflite",
      labels: "assets/labels/labelspapaya.txt",
    );
  }

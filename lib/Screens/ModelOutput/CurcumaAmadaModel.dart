...
class ModelTestCurcumaAmada extends StatefulWidget {
  @override
  _ModelTestCurcumaAmadaState createState() => _ModelTestCurcumaAmadaState();
}

class _ModelTestCurcumaAmadaState extends State<ModelTestCurcumaAmada> {
  bool _loading = false;
  File? _image;
  List? _output;
    ...
    _output != null && (_output![0]['label'].toString().substring(0, 1) == "0")
        ? Future.delayed(Duration(milliseconds: 1000), () {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => const CurcumaAmada()));
          })
        : Future.delayed(Duration(milliseconds: 1000), () {
            _onAlertButtonPressed1(context);
          });
  ...
  void loadModel() async {
    await Tflite.loadModel(
      model: "assets/models/model_curcumaamada.tflite",
      labels: "assets/labels/labelscurcumaamada.txt",
    );
  }

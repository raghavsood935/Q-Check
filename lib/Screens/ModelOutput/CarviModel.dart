...
class ModelTestCarvi extends StatefulWidget {
  @override
  _ModelTestCarviState createState() => _ModelTestCarviState();
}

class _ModelTestCarviState extends State<ModelTestCarvi> {
  bool _loading = false;
  File? _image;
  List? _output;
  ...
  void loadModel() async {
    await Tflite.loadModel(
      model: "assets/models/model_carvi.tflite",
      labels: "assets/labels/labelscarvi.txt",
    );
  }

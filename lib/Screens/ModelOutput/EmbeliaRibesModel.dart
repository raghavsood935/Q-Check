...
class ModelTestEmbeliaRibes extends StatefulWidget {
  @override
  _ModelTestEmbeliaRibesState createState() => _ModelTestEmbeliaRibesState();
}

class _ModelTestEmbeliaRibesState extends State<ModelTestEmbeliaRibes> {
  bool _loading = false;
  File? _image;
  List? _output;
    ...
    _output != null && (_output![0]['label'].toString().substring(0, 1) == "0")
        ? Future.delayed(Duration(milliseconds: 1000), () {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => EmbeliaRibes()));
          })
        : Future.delayed(Duration(milliseconds: 1000), () {
            _onAlertButtonPressed1(context);
          });
  ...
  void loadModel() async {
    await Tflite.loadModel(
      model: "assets/models/model_embeliaribes.tflite",
      labels: "assets/labels/labelsembeliaribes.txt",
    );
  }

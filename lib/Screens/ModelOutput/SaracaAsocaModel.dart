...
import 'package:q_check/Screens/herbs/herbs_details/ashokabark.dart';
import 'package:q_check/Screens/herbs/herbs_details/falseasoka.dart';
import 'package:tflite/tflite.dart';
import 'dart:io';

class ModelTestSaracaAshoka extends StatefulWidget {
  @override
  _ModelTestSaracaAshokaState createState() => _ModelTestSaracaAshokaState();
}

class _ModelTestSaracaAshokaState extends State<ModelTestSaracaAshoka> {
  bool _loading = false;
  File? _image;
  List? _output;
    ...
    if (_output != null &&
      ...
      Future.delayed(Duration(milliseconds: 1000), () {
        Navigator.push(context,
            MaterialPageRoute(builder: (context) => const SaracaAsoca()));
      });
      ...
      Future.delayed(Duration(milliseconds: 1000), () {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => const PolyalthiaLongifolia()));
      });
    } else {
      Future.delayed(Duration(milliseconds: 1000), () {
        _onAlertButtonPressed1(context);
  ...
  void loadModel() async {
    await Tflite.loadModel(
      model: "assets/models/model_saraca.tflite",
      labels: "assets/labels/labelssaraca.txt",
    );
  }
